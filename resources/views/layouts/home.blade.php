    ...
    <section id="hero" class="text-white tm-font-big tm-parallax">
        ...
        <div class="container">   
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                  <a class="nav-link tm-nav-link" href="/pengaduan">Pengaduanmu</a>
              </li>
              <li class="nav-item">
                  <a class="nav-link tm-nav-link" href="pengaduan/create">pengaduan</a>
              </li>
              ...
              <li class="nav-item">
                  <a class="nav-link tm-nav-link" href="/admin">Halaman Admin</a>
              </li>
              <li class="nav-item">
                  <a class="nav-link tm-nav-link" href="/logout">logout</a>
              </li>                    
              ...
              <li class="nav-item">
                  <a class="nav-link tm-nav-link" href="/petugas">Halaman Petugas</a>
              </li>
              <li class="nav-item">
                  <a class="nav-link tm-nav-link" href="/logout">Log Out</a>
              </li>

              @else (return redirect(/login)->with('alert','Login dulu cuy');)
              @endif
      ...
      <div class="text-center tm-hero-text-container">
        <div class="tm-hero-text-container-inner">
            <h2 class="tm-hero-title">SIM Pengaduan</h2>
