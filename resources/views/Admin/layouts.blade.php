      ...
      <nav class="navbar navbar-expand-lg py-3 bg-dash-dark-2 border-bottom border-dash-dark-1 z-index-10">
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between py-1">
          <div class="navbar-header d-flex align-items-center"><a class="navbar-brand text-uppercase text-reset" href="index.html">
              ...
              <div class="brand-text brand-sm"><strong class="text-primary">AD</strong><strong>min</strong></div></a>
    ...
    <div class="d-flex align-items-stretch">
      ...
      <nav id="sidebar">
        ...
        <ul class="list-unstyled">
              ...
              <li class="sidebar-item"><a class="sidebar-link" href="/pengaduanadmin"> 
                      <svg class="svg-icon svg-icon-sm svg-icon-heavy">
              ...
              <li class="sidebar-item"><a class="sidebar-link" href="/tanggapanadmin"> 
                      ...
                      <li class="sidebar-item"><a class="sidebar-link" href="/historyadmin"> 
                      <svg class="svg-icon svg-icon-sm svg-icon-heavy">
                        <use xlink:href="#survey-1"> </use>
                      </svg><span>Histpry </span></a></li>
              ...
              <li class="sidebar-item"><a class="sidebar-link" href="#exampledropdownDropdown" data-bs-toggle="collapse"> 
                ...
                <ul class="collapse list-unstyled " id="exampledropdownDropdown">
                  <li><a class="sidebar-link" href="/akun">Admin</a></li>
                  <li><a class="sidebar-link" href="/akun">Petugas</a></li>
                  <li><a class="sidebar-link" href="/akunmasyarakat">Masyarakat</a></li>
                </ul>
              </li>
                  ...
                  <div class="card-body">
                    <div class="d-flex align-items-end justify-content-between mb-2">
                      <div class="me-2">
                        ...
                        <p class="text-sm text-uppercase text-gray-600 lh-1 mb-0">Jumlah User</p>
                        
                      </div>
                      <?php
                                            $user_count = DB::table('users')->count();    
                                        ?>
                      <p class="text-xxl lh-1 mb-0 text-dash-color-1">{{ $user_count }}</p>
                    </div>
                  ...
                  <div class="card-body">
                    <div class="d-flex align-items-end justify-content-between mb-2">
                      <div class="me-2">
                        ...
                        <p class="text-sm text-uppercase text-gray-600 lh-1 mb-0">Jumlah Petugas</p>
                      </div>
                      <?php
                                            $account_counts = DB::table('users')->wherein('role', ['petugas'])->count();    
                                        ?>

                      <p class="text-xxl lh-1 mb-0 text-dash-color-2">{{ $account_counts }}</p>
                    </div>
                    <div class="progress" style="height: 3px">
                  ...
                  <div class="card-body">
                    <div class="d-flex align-items-end justify-content-between mb-2">
                      <div class="me-2">
                        ...
                        <p class="text-sm text-uppercase text-gray-600 lh-1 mb-0">Jumlah Pengaduan</p>
                      </div>
                         <?php
                                            $laporan_counts = DB::table('pengaduans')->count();    
                                        ?>
                      <p class="text-xxl lh-1 mb-0 text-dash-color-3">{{ $laporan_counts }}</p>
                    </div>
                    <div class="progress" style="height: 3px">
                  ...
                  <div class="card-body">
                    <div class="d-flex align-items-end justify-content-between mb-2">
                      <div class="me-2">
                        ...
                        <p class="text-sm text-uppercase text-gray-600 lh-1 mb-0">Jumlah Tanggapan</p>
                      </div>
                      <?php
                                            $tanggapan_counts = DB::table('tanggapans')->count();    
                                        ?>
                      <p class="text-xxl lh-1 mb-0 text-dash-color-3">{{ $tanggapan_counts }}</p>
                    </div>
                    <div class="progress" style="height: 3px">
