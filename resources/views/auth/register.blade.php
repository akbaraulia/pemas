                    ...
                    <main class="form-register">
                        <form action="/register" method="POST">
                           @csrf
                            ...
                            <div class="form-floating">
                                <input type="text" name="nik" class="form-control mt-2" id="nik" placeholder="masukan NIK anda">
                                <label for="nik">NIK</label>
                            </div>
                            <div class="form-floating">
                                <input type="text" name="telp" class="form-control mt-2" id="telp" placeholder="masukan No Telepon anda">
                            ...
                            <div class="form-floating">
                                <input type="text" name="role" class="form-control mt-2" id="role" value="masyarakat" placeholder="role">
