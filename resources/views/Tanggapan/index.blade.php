    ...
    <div class="d-flex align-items-stretch">
      ...
      <nav id="sidebar">
        ...
        <ul class="list-unstyled">
              ...
              <li class="sidebar-item "><a class="sidebar-link" href="/pengaduanpetugas"> 
                      <svg class="svg-icon svg-icon-sm svg-icon-heavy">
                        <use xlink:href="#portfolio-grid-1"> </use>
                      </svg><span>Pengaduan </span></a></li>
              <li class="sidebar-item active"><a class="sidebar-link" href="/tanggapanpetugas"> 
                      <svg class="svg-icon svg-icon-sm svg-icon-heavy">
    ...
    <div class="d-flex align-items-stretch">
      ...
      <nav id="sidebar">
        ...
        <ul class="list-unstyled">
              ...
              <li class="sidebar-item active"><a class="sidebar-link" href="/tanggapanadmin"> 
                      <svg class="svg-icon svg-icon-sm svg-icon-heavy">
                        <use xlink:href="#survey-1"> </use>
                      </svg><span>Tanggapan </span></a></li>
